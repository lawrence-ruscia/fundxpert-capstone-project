...
import type { WithdrawalDocument } from '../../employee/types/withdrawal';

export const SupportingWithdrawalDocuments = ({
  documents,
  ...
  return (
    <Card className='w-full'>
      <CardHeader>
        ...
        <CardDescription>
          Documents submitted by the employee to support their withdrawal
          request.
        </CardDescription>
      </CardHeader>
