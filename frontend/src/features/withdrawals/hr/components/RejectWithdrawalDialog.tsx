...
export function RejectWithdrawalDialog({
  ...
  const handleRejectRequest = async () => {
    try {
      ...
      await reviewWithdrawalDecision(
        Number(withdrawalId),
        'Rejected',
        comments
      );
      ...
      toast.success(
        `Withdrawal request #${withdrawalId} has been rejected. The employee has been notified.`
      );
    ...
    <ConfirmDialog
      ...
      desc={
        <div className='space-y-4'>
          <p>
            This will reject the withdrawal request completely. The withdrawal
            request process will be stopped and the employee will be notified of
            the rejection.
          </p>
          ...
          <Label>
            ...
            <Textarea
              ...
              placeholder='Provide a clear explanation for why this request is being rejected...'
              rows={4}
              className='mt-2'
            />
          </Label>
          ...
          <Alert variant='destructive'>
            ...
            <AlertDescription>
              Once rejected, the withdrawal request will be closed. The employee
              may submit a new request after addressing the concerns mentioned
              in your rejection reason.
            </AlertDescription>
          </Alert>
        </div>
      }
