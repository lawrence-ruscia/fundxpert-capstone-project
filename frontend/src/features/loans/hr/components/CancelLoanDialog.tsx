...
export function CancelLoanDialog({
  ...
  const handleCancelLoan = async () => {
    try {
      ...
      await cancelLoanRequest(Number(loanId), reason);
      await refreshAccess();
      setActionLoading(false);

      toast.success(
        `Loan #${loanId} has been cancelled. The employee has been notified.`
      );
    ...
    <ConfirmDialog
      ...
      desc={
        <div className='space-y-4'>
          <p>
            **Are you sure you want to cancel this loan application?** This
          ...
          <Alert variant='destructive'>
            ...
            <AlertDescription>
              The employee will be notified of the cancellation. This loan
              cannot be reopened and the employee will need to submit a new
              application.
            </AlertDescription>
          </Alert>
        </div>
