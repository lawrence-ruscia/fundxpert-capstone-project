...
import { getAllContributions } from '../services/hrContributionsService';
import { getEmployeeById } from '../services/hrService';
import { isAuthenticatedRequest } from './employeeControllers';
...
export async function exportEmpContributionsPDF(req: Request, res: Response) {
  try {
    ...
    // Employees can only export their own contributions
    if (user.role !== 'Employee') {
      return res.status(403).json({
        error: 'This endpoint is for employee self-service only',
      });
    }

    // Fetch employee info and contributions
    ...
    const doc = new PDFDocument({
      ...
      size: 'A4',
      info: {
        Title: 'My Provident Fund Contributions',
        Author: 'FundXpert System',
        Subject: 'Employee Contribution History',
        Creator: 'FundXpert',
        Keywords: 'Provident Fund, Contributions, Employee Statement',
      },
    });
    ...
    const dateRange = startDate && endDate ? `_${startDate}_to_${endDate}` : '';
    const lastName = employee.name.split(' ').pop() || 'Employee';
    const filename = `My_PF_Contributions_${lastName}_${employee.employee_id}${dateRange}_${timestamp}.pdf`;
    ...
    const addFooter = () => {
      ...
      doc
        ...
        .font('Helvetica')
        .text(
          'This is your personal contribution statement. Please keep this document for your records.',
          40,
          footerY,
    ...
    doc
      ...
      .fontSize(11)
      .font('Helvetica-Bold')
      .text('PERSONAL STATEMENT', 420, currentY, { align: 'right' });

    doc
      .fillColor(colors.secondary)
      .fontSize(10)
      .font('Helvetica')
      .text('Provident Fund Services', 40, currentY + 40);
    ...
    doc
      ...
      .fontSize(20)
      .font('Helvetica-Bold')
      .text('MY CONTRIBUTION HISTORY', 40, currentY, {
        align: 'center',
      });
    ...
    doc
      .fontSize(14)
      .fillColor(colors.secondary)
      .text('Provident Fund Statement', 40, currentY, { align: 'center' });
    ...
    doc
      ...
      .fontSize(12)
      .font('Helvetica-Bold')
      .text('STATEMENT DETAILS', 60, currentY);
    ...
    doc
      ...
      .fontSize(10)
      .font('Helvetica')
      .text('Statement Date:', 60, currentY)
      .font('Helvetica-Bold')
      .text(
        new Date().toLocaleString('en-US', {
          year: 'numeric',
    ...
    doc
      ...
      .fontSize(11)
      .font('Helvetica-Bold')
      .text('EMPLOYEE INFORMATION', 60, currentY);
    ...
    doc
      ...
      .font('Helvetica')
      .text(
        `Name: ${employee.name} | Employee ID: ${employee.employee_id}`,
        60,
        currentY
      );
    ...
    currentY += 12;
    doc.text(
      `Employment Status: ${employee.employment_status} | Date Hired: ${new Date(employee.date_hired).toLocaleDateString()}`,
      60,
      currentY
    );
    ...
    doc
      ...
      .fontSize(11)
      .font('Helvetica-Bold')
      .text('STATEMENT PERIOD', 60, currentY);
    ...
    if (startDate && endDate) {
      ...
      doc.text('Period: Complete History (All Time)', 60, currentY);
    }

    currentY += 12;
    doc.text(
      `Total Contributions: ${contributions.length} | Current Balance: Review full statement below`,
      60,
      currentY
    );
    ...
    doc
      ...
      .text('My Contribution', columnPositions.employeeAmount + 2, currentY, {
        width: columnWidths.employeeAmount - 4,
        align: 'center',
      })
      .text('Employer Match', columnPositions.employerAmount + 2, currentY, {
    ...
    const drawTableHeader = (y: number) => {
      ...
      doc
        ...
        .text('My Contribution', columnPositions.employeeAmount + 2, headerY, {
          width: columnWidths.employeeAmount - 4,
          align: 'center',
        })
        .text('Employer Match', columnPositions.employerAmount + 2, headerY, {
          width: columnWidths.employerAmount - 4,
          align: 'center',
        })
    ...
    contributions.forEach((contribution, index) => {
      ...
      doc
        ...
        .font('Helvetica')
        .fillColor(contribution.is_adjusted ? colors.warning : colors.success)
        .text(
        ...
        .fontSize(7)
        .text(
          truncateText(contribution.notes || '-', 25),
    ...
    doc
      ...
      .fontSize(14)
      .font('Helvetica-Bold')
      .text('CONTRIBUTION SUMMARY', labelX, contentY);
    ...
    doc
      .fontSize(11)
      .font('Helvetica')
      .text('Your Total Contributions:', labelX, contentY)
      .font('Helvetica-Bold')
      .text(
    ...
    doc
      .font('Helvetica')
      .text('Employer Total Contributions:', labelX, contentY)
      .font('Helvetica-Bold')
      .text(
    ...
    doc
      ...
      .fontSize(13)
      .font('Helvetica-Bold')
      .text('TOTAL FUND BALANCE:', labelX, contentY)
      .text(
    ...
    // Add disclaimer
    currentY = summaryBoxY + summaryBoxHeight + 25;
    doc
      .fillColor(colors.secondary)
      .fontSize(9)
      .font('Helvetica-Oblique')
      .text(
        'Note: This statement reflects contributions recorded in the system for the specified period. For inquiries or discrepancies, please contact the HR department.',
        60,
        currentY,
